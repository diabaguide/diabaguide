...
export const STATIC_CATEGORIES: Category[] = [
  { id: 'gros', label: 'Marchés', labelCn: '批发', icon: 'box', ctaLabel: 'Contacter le fournisseur', tagsLabel: 'Produits proposés', fields: ['moq', 'hours'], isFreight: false, active: true, sort: 1 },
