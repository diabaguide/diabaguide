...
--
-- `city` est en minuscules (guangzhou/shenzhen) : depuis supabase/taxonomies.sql,
-- providers.city référence public.cities(id), qui utilise cet identifiant en
-- minuscules — et non plus l'ancien enum provider_city ('Guangzhou'/'Shenzhen'
-- avec majuscule) que schema.sql laisse pourtant supposer à la lecture.
